        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-3">
              <Button onClick={() => saveMutation.mutate()} disabled={saveMutation.isPending || !form.name} className="bg-primary text-primary-foreground hover:bg-accent rounded-pill">
                    ...
                    <tr key={a.id} className="border-b last:border-0">
                      ...
                      <td className="py-2 px-3 text-center">
                        <Switch
                          ...
                          onCheckedChange={(checked) => toggleEnabled.mutate({ id: a.id, is_enabled: checked })}
                        />
                      </td>
