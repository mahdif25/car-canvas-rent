...
import { X, Plus, Trash2, Phone, Mail, Calendar, TrendingUp, DollarSign, Wrench, ArrowDownUp } from "lucide-react";
...
const FleetPlateDetail = ({ plate, reservations, expenses, onClose }: Props) => {
      ...
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        <div>
          <CardTitle className="text-lg flex items-center gap-2">
            <span className="font-mono bg-muted px-2 py-1 rounded text-base">{plate.plate_number}</span>
            <span className="text-muted-foreground font-normal text-sm">{plate.brand} {plate.model}</span>
          </CardTitle>
        </div>
